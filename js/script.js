...
button.addEventListener("click", function () {
    if (fileInput.files.length > 0) {
        ...
        if (window.screen.availWidth <= 380) {
            Qrcode("https://qrcode-generator-xi-one.vercel.app/", "#000", "#fff", false, "../img/logo-big.png", 200, 200);
        } else {
            Qrcode("https://qrcode-generator-xi-one.vercel.app/", "#000", "#fff", false, "../img/logo-big.png", 280, 280);
        }
    }
});
...
document.querySelector(".white").addEventListener("click", function () {
    ...
    if (fileInput.files.length > 0) {
        ...
        if (window.screen.availWidth <= 380) {
            Qrcode("https://qrcode-generator-xi-one.vercel.app/", "#fff", "#000", false, "../img/logo-big.png", 200, 200);
        } else {
            Qrcode("https://qrcode-generator-xi-one.vercel.app/", "#fff", "#000", false, "../img/logo-big.png", 280, 280);
        }
    }
